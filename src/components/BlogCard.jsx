export default function BlogCard({ url, title, excerpt, imageUrl, date, tags }) {
  return (
      <a href={`/turing-machine`} className="border border-customLightGray rounded shadow p-4 flex flex-col cursor-pointer">
